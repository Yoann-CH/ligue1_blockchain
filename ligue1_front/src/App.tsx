...
import { VotingContext, useGlobalVotingState } from './hooks/useGlobalVotingState';
...
function App() {
  ...
  const votingContextValue = useGlobalVotingState();
        ...
        <footer className="bg-black text-white py-8 mt-16 border-t border-gray-800">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-sm text-gray-400">
              Développé avec ❤️ pour le football français
            </p>
          </div>
        </footer>

        {/* Overlay de chargement global pendant le vote */}
        <LoadingOverlay 
          isActive={votingContextValue.votingState.isVoting} 
          message={votingContextValue.votingState.message}
        />
